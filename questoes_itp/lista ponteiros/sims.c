...
int simula_sims(int *fome, int *sede, int *banheiro, int *sono, int *tedio) {
    ...
    if (strcmp(acao, "comer") == 0) {
        ...
        *sede -= 30;
        *banheiro -= 30;
    } else if (strcmp(acao, "se") == 0) {
        char subacao[20];
        scanf("%s", subacao);
        if (strcmp(subacao, "aliviar") == 0) {
            *banheiro += 100;
        }
    } else if (strcmp(acao, "jogar") == 0) {
        char subacao[20];
        scanf("%s", subacao);
        if (strcmp(subacao, "videogame") == 0) {
            *tedio += 80;
            *fome -= 20;
            *sede -= 20;
            *sono -= 20;
    ...
    if (strcmp(acao, "se") != 0 || strcmp(acao + 1, "aliviar") != 0) {
        *fome -= 5;
        *sede -= 5;
        *banheiro -= 5;
        *sono -= 5;
